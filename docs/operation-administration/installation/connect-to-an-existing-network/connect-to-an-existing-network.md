...
In this example we will setup a TruBudget Blockchain with API and Frontend in docker-compose. After a successfully setup, we can create another TruBudget Blockchain that will be the slave-node and trys to connect to the master-node.
